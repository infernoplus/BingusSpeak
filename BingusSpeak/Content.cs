...
namespace BingusSpeak
{
    ...
    public abstract class CharacterContent : Content
    {
        ...
        public bool important; // marked if an npc has any unique dialog lines assigned to them. ('speaker_id' in data) if they only get generic lines then its set to false
